...
export const generaters = {
    ...
    'Bls12381': bls12381Multikey.generateBbsKeyPair.bind(EcdsaMultikey, { algorithm: 'BBS-BLS12-381-SHA-256' })
}
...
function get_suite(key) {
    const multibaseMultikeyHeader = key.publicKeyMultibase.slice(0, 4);
